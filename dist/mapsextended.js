...
/* WEBPACK VAR INJECTION */}.call(__webpack_exports__, __webpack_require__(10), __webpack_require__(11)(module)))
...
module.exports = (__webpack_require__(1))("f1Eh");
 ...
 */
(0, _registry.registerFieldComponent)('mapsextended', _2.default);
...
exports.enhance = exports.MapsExtendedField = undefined;
...
var _withStore = __webpack_require__(7);
 ...
 * The internal dependencies.
 */
var MapsExtendedField = exports.MapsExtendedField = function MapsExtendedField(_ref) {
  var name = _ref.name,
      field = _ref.field,
  ...
  return _react2.default.createElement(
    ...
    _react2.default.createElement(_Map2.default, { field: field, onChange: handleChange })
  );
};
...
exports.default = (0, _recompose.setStatic)('type', ['mapsextended'])(enhance(MapsExtendedField));
...
var Map = function (_React$Component) {
  ...
  function Map(props) {
    ...
    _this.initMapTermInputs = function () {
      return new Promise(function (resolve) {
        _this.radioInputs = document.querySelectorAll('[data-term-radio]');

        var checkedInputFound = false;
        [].concat(_toConsumableArray(_this.radioInputs)).forEach(function (input) {
          ...
          if (input.getAttribute('checked') === 'checked') {
            ...
            _this.setState({ activeMapTermInput: input }, resolve);
          }
        });
    ...
    _this.initFeatureTypeInputs = function () {
      return new Promise(function (resolve) {
        _this.featureTypeInputs = document.querySelectorAll('[data-feature-type-select]');

        var checkedInputFound = false;
        [].concat(_toConsumableArray(_this.featureTypeInputs)).forEach(function (input) {
          if (checkedInputFound) {
            return;
          }
          ...
          if (input.getAttribute('checked') === 'checked') {
            checkedInputFound = true;
            _this.setState({ activeFeatureType: input.getAttribute('feature-type-value') }, resolve);
          }
        });
    ...
    _this.getDrawOptions = function () {
      return ['marker', 'circlemarker', 'circle', 'polygon', 'rectangle', 'polyline'].reduce(function (options, feature) {
        return Object.assign({}, options, _defineProperty({}, feature, _this.state.activeFeatureType === feature));
      }, {});
    };

    _this.setMapPosition = function () {
      return new Promise(function (resolve) {
        var position = _this.state.activeMapTermInput ? JSON.parse(_this.state.activeMapTermInput.getAttribute('data-position')) : Object.assign({}, _constants.DEFAULT_MAP_POSITION);

        _this.setState({ position: [position.center, position.zoom] }, function () {
          var _this$map;

          (_this$map = _this.map).setView.apply(_this$map, _toConsumableArray(_this.state.position));
          resolve();
        });
      });
    };
    ...
    _this.render = function () {
      return _react2.default.createElement(StyledMapContainer, _extends({
        innerRef: function innerRef(container) {
          _this.node = container;
        }
      }, _this.state));
    };
  ...
  _createClass(Map, [{
        ...
        return _regenerator2.default.wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                _context.next = 2;
                return this.initMapTermInputs();

              case 2:
                this.initMapTermInputListeners();
                _context.next = 5;
                return this.initFeatureTypeInputs();
    ...
    key: 'initMapTermInputListeners',
    value: function initMapTermInputListeners() {
      var _this2 = this;

      [].concat(_toConsumableArray(this.radioInputs)).forEach(function (input) {
        input.addEventListener('change', function () {
          _this2.setState({ activeMapTermInput: input }, _this2.setMapPosition);
        });
      });
    }
  }, {
    key: 'initFeatureTypeInputListeners',
    value: function initFeatureTypeInputListeners() {
      var _this3 = this;

      [].concat(_toConsumableArray(this.featureTypeInputs)).forEach(function (input) {
    ...
    key: 'deactivateInactiveTypeInputs',
    value: function deactivateInactiveTypeInputs() {
      var _this4 = this;

      [].concat(_toConsumableArray(this.featureTypeInputs)).forEach(function (input) {
        if (input.getAttribute('data-feature-type-value') !== _this4.state.activeFeatureType) {
          input.setAttribute('disabled', true);
        }
      });
    }
  }, {
    key: 'activateTypeInputs',
    value: function activateTypeInputs() {
      [].concat(_toConsumableArray(this.featureTypeInputs)).forEach(function (input) {
     ...
     * @return {void}
     */
    value: function initDrawControl() {
    ...
    key: 'switchToEditControl',
    value: function switchToEditControl() {
      this.map.removeControl(this.drawControlFull);
      this.map.addControl(this.drawControlEdit);
    }
  }, {
    key: 'switchToFullControl',
    value: function switchToFullControl() {
    ...
    key: 'initDrawEventListeners',
    value: function initDrawEventListeners() {
      var _this6 = this;

      this.map.on(L.Draw.Event.CREATED, function (event) {
        var layer = event.layer;
        _this6.drawnItems.addLayer(layer);
        _this6.saveData(layer);
        _this6.switchToEditControl();
        _this6.setState({ hasFeature: true });
      });
      ...
      this.map.on(L.Draw.Event.DELETED, function () {
        _this6.switchToFullControl();
        _this6.setState({ hasFeature: false });
      });
    }
  }, {
    key: 'initFeature',
    value: function initFeature() {
      var _ref2 = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : this.props.field,
          value = _ref2.value;
      ...
      switch (value.type) {
        case 'marker':
          {
            this.drawnItems.addLayer(new L.Marker([value.latlng.lat, value.latlng.lng]));
            return;
          }
        case 'circle':
          {
            this.drawnItems.addLayer(new L.Circle([value.latlng.lat, value.latlng.lng], {
              radius: value.radius
            }));
            return;
          }
        case 'circlemarker':
          {
            this.drawnItems.addLayer(new L.CircleMarker([value.latlng.lat, value.latlng.lng]));
            return;
          }
        case 'polygon':
          {
...
var debug = __webpack_require__(45)('css-color-function:parse');
...
exports.STYLE_VARIABLES = exports.DEFAULT_MAP_POSITION = undefined;

var _cssColorFunction = __webpack_require__(34);

var _cssColorFunction2 = _interopRequireDefault(_cssColorFunction);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

var DEFAULT_MAP_POSITION = exports.DEFAULT_MAP_POSITION = {
  center: [44.564211, -69.662536],
  zoom: 16
};

var STYLE_VARIABLES = exports.STYLE_VARIABLES = {
  primary: '#214280',
  primaryHighlight: _cssColorFunction2.default.convert('color(#214280 shade(10%))'),
  primaryLight: _cssColorFunction2.default.convert('color(#214280 tint(10%))')
};
...
var parse = __webpack_require__(32);
var adjusters = __webpack_require__(48);
...
module.exports = (__webpack_require__(1))("DuR2");
