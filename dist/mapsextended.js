...
var Map = function (_React$Component) {
  ...
  function Map(props) {
    ...
    _this.initTermRadioInputs = function () {
      return new Promise(function (resolve) {
        ...
        [].concat(_toConsumableArray(_this.radioInputs)).forEach(function (input) {
          ...
          if (input.getAttribute('checked') === 'checked') {
            ...
            _this.setState({ activeTermRadioInput: input }, resolve);
          }
        });
    ...
    _this.setMapPosition = function () {
      return new Promise(function (resolve) {
        var position = _this.state.activeTermRadioInput ? JSON.parse(_this.state.activeTermRadioInput.getAttribute('data-position')) : Object.assign({}, _constants.DEFAULT_MAP_POSITION);
    ...
    _this.render = function () {
      return _react2.default.createElement(StyledMapContainer, {
  ...
  _createClass(Map, [{
        ...
        return _regenerator2.default.wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                _context.next = 2;
                return this.initTermRadioInputs();
    ...
    key: 'initTermRadioInputListeners',
    value: function initTermRadioInputListeners() {
      var _this2 = this;

      [].concat(_toConsumableArray(this.radioInputs)).forEach(function (input) {
        input.addEventListener('change', function () {
          _this2.setState({ activeTermRadioInput: input }, _this2.setMapPosition);
        });
      });
    }
    ...
    value: function initDrawEventListeners() {
      ...
      this.map.on(L.Draw.Event.CREATED, function (event) {
        ...
        _this4.saveData(layer);
        _this4.drawnItems.addLayer(layer);
        _this4.switchToEditControl();
      });
