 ...
 */
(0, _registry.registerFieldComponent)('mapposition', _2.default);
...
exports.enhance = exports.MapPosition = undefined;
 ...
 * The internal dependencies.
 */
var MapPosition = exports.MapPosition = function MapPosition(_ref) {
  var name = _ref.name,
      field = _ref.field,
...
exports.default = (0, _recompose.setStatic)('type', ['mapposition'])(enhance(MapPosition));
...
var Map = function (_React$Component) {
  ...
  function Map() {
    ...
    }, _this.saveData = _this.saveData.bind(_this), _temp), _possibleConstructorReturn(_this, _ret);
  }
  ...
  _createClass(Map, [{
    ...
    value: function getViewProps() {
      try {
        if (this.props.field.value.center && this.props.field.value.zoom) {
          ...
          return [_constants.DEFAULT_MAP_POSITION.center, _constants.DEFAULT_MAP_POSITION.zoom];
        }
      } catch (e) {
        return [_constants.DEFAULT_MAP_POSITION.center, _constants.DEFAULT_MAP_POSITION.zoom];
      }
    ...
    value: function initMap() {
      ...
      this.map = (_L$map = L.map(this.node)).setView.apply(_L$map, _toConsumableArray(this.getViewProps()));
